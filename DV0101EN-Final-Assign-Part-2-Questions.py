...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(id='input-type', 
             options=[
                 {'label': 'Recession Period', 'value': 'Recession'},
                 {'label': 'Non-Recession Period', 'value': 'Non-Recession'}
             ],
             placeholder='Select a Period',
             style={'width': '50%', 'padding': '3px', 'font-size': '18px', 'textAlign': 'center'})
    ]),
...
def update_input_container(selected_input):
    if selected_input == 'Yearly Statistics': 
        return False
    else: 
        return True
...
def update_output_container(selected_input, selected_year):
    if selected_input == 'Recession Period Statistics':
...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        x='Year',
        y='Automobile_Sales',
        title="Yearly Average Automobile Sales during Recession Period"))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
    ...
    figure=px.line(yas,
        x='Year',
        y='Automobile_Sales',
        title='Yearly Average Automobile Sales Over the Entire Period')
)           
